...
import livraria.controller.Emprestimo_CRUD;
...
public class Emprestimo extends javax.swing.JFrame {
    ...
    int idemprestimo=0, idlivro=0, qtDias=0, quant=0;
    String nomelivro, cod;
    
    ArrayList<Emprestimo> list_emprestimo = new ArrayList<Emprestimo>();
    int x=0;
    ...
    private void initComponents() {
        ...
        label_idLivroEmprestimo = new javax.swing.JLabel();
        ...
        label_idLivroEmprestimo.setFont(new java.awt.Font("Dialog", 0, 12)); // NOI18N
        label_idLivroEmprestimo.setText("IDLivro");
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                                .addGap(66, 66, 66)
                                .addComponent(label_idLivroEmprestimo)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       ...
       Livro_model v2 = new Livro_model();
       
       if(x==1){ 

       v1.setCpf(cod);
       v.setIdItemEmprestimo(idemprestimo);
       v2.setIdLivro(idlivro);
       v2.setNomeLivro(nomelivro);
       
       try { 
            DateFormat formatador = new SimpleDateFormat("dd/MM/yyyy");
            v.setDataEmprestimo(new java.sql.Date(((java.util.Date) formatador.parse(jFormattedTextField2.getText())).getTime()));
           } catch (ParseException ex) {
               Logger.getLogger(Emprestimo.class.getName()).log(Level.SEVERE, null, ex);
           }
       
       Emprestimo_CRUD ven = new Emprestimo_CRUD();
       ven.salvar(v);
       }
       x++;
      
       v2.setIdLivro(Integer.parseInt(jTextField1.getText()));
       v2.setNomeLivro(jTextField5.getText());
       v.setIdItemEmprestimo(Integer.parseInt(jTextField2.getText()));
       
       Emprestimo_CRUD item = new Emprestimo_CRUD();
       item.salvar(v);
       
       v.setIdItemEmprestimo(v.getIdItemEmprestimo());
       v1.setCpf(v1.getCpf());
       qtDias = quant - v.getQtdDias();
       v.setQtdDias(qtDias);
       Emprestimo_CRUD e = new Emprestimo_CRUD();
       e.alterar(v, v1);
    }//GEN-LAST:event_jButton2ActionPerformed
    
     private void busca() {
        Emprestimo_CRUD emp = new Emprestimo_CRUD();
        c.conectar();
        jTextField1.setText(String.valueOf(idlivro+1));
    ...
    private javax.swing.JLabel label_idLivroEmprestimo;
